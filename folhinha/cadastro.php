    ...
    <div class="login-container">
        ...
        <form class="login-form" action="cadastro.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="cpf" name="cpf" placeholder="000.000.000-00" required pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite um CPF no formato 000.000.000-00">
            </div>
